	...
	static init() { //Initialize the editor. This generates all the controls and buttons
		...
		this.Menu = new TabControl({
			...
			Tabs: [
				...
				{Label: "Areas", Content: {
					Type: "HTML",
					Value: "<fieldset></fieldset><fieldset id=\"" + this.Anchors.Menu.Areas + "\" style=\"max-height: 500px; overflow: auto\"><legend>Areas available</legend></fieldset><fieldset id=\"" + this.Anchors.Menu.AreaOptions + "\"><legend>Options</legend></fieldset>", //<legend>Management</legend>
				}},
				...
				{Label: "Results", Content: {Type: "HTML", Value: "<fieldset></fieldset><fieldset id=\"" + this.Anchors.Menu.Results + "\" style=\"max-height: 500px; overflow: auto\"><legend>Results available</legend></fieldset>"} }, //<legend>Controls</legend>
		...
		this.Tables = {
			Areas: new RespTable({ID: this.Anchors.Menu.Areas, Fields: ["Type", "Name", "Color", "Other"], Preserve: true, FullWidth: true, RowNumbers: true, onDelete: function(a) {this.deleteArea(a)}.bind(this)}),
		...
		GetId(this.Anchors.Menu.Areas).previousSibling.append(LinkCtrl.buttonBar([
			{Label: "Untag all", Title: "Remove tagged areas for the entire plate", Click: function() {this.untagAllArea()}.bind(this)},
		...
		GetId(this.Anchors.Menu.Conc).prepend(LinkCtrl.buttonBar([
			...
			{Label: "Untag", Title: "Untag the defined concentrations in the selection", Click: function() {this.untagConc()}.bind(this)},
			{Label: "Tag", Title: "Tag the defined concentrations in the selection", Icon: {Type: "Tag", Space: true}, Click: function() {this.tagConc()}.bind(this)},
		]));
...
//************************
	...
	static pairing() { //Pairing of result and definition plates
		...
		if(definitions.length == 0 || results.length == 0) {this.Console.log({Message: "No result or definition available for pairing", Gravity: "Error"}); return this}
