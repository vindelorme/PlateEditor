...
class Plate {
	constructor(root, r, c) {
		...
		this.Controls = {
			LayerSelect: LinkCtrl.new("Select", {ID: this.Anchors.LayerSelect, Title: "Select the layer to use for display", Default: 0, Label: "Layer", List: [1], Change: function(v) {this.Layers[v].concMap(this.Anchors.LayerSelect)}.bind(this)}),
		}
